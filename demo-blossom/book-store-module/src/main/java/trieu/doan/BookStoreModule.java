...
/**
 * This class manages the lifecycle of the bookStoreModule module. It starts and stops Spring when Magnolia starts up and
 ...
 */
public class BookStoreModule extends BlossomModuleSupport implements ModuleLifecycle {
